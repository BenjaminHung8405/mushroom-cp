...
describe('AdminDevicesController', () => {
  ...
  beforeEach(async () => {
    ...
    houseRepo = {
      ...
      findOneBy: jest.fn().mockResolvedValue({ id: 'house_b1', name: 'Nhà B1' }),
    };

    userRepo = {
      find: jest.fn().mockResolvedValue([{ id: 'op-1', phoneNumber: '+84901111111' }]),
    };
  ...
  it('should list devices with online status calculation', async () => {
