...
namespace config {
  ...
  namespace hardware {
    ...
    // 3. I2C Devices
    constexpr uint8_t I2C_DISPLAY_ADDR = 0x51; // Địa chỉ I2C của thiết bị Display
    constexpr uint8_t I2C_DISPLAY_MODE = 1;    // 0 = padding trái, 1 = đảo ngược chuỗi & padding phải
  }
