...
| A5 | Thêm include `ota_manager.h` vào `core0_tasks.cpp` | `[ ] QA Review` | **[Sprint 3]** Include `ota_manager.h` để phục vụ gọi API kiểm tra trigger. Đảm bảo file header có guard đầy đủ và không kéo theo các module phụ thuộc phần cứng khi chạy unit test native. |
