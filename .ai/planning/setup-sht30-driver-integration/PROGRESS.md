...
- **Sprints tham chiếu**:
  1. [sprint_1.md (PlatformIO & Include Driver SHT30) — ✅ DONE](file:///Users/benjaminhung8405/Code/mushroom-cp/.ai/planning/setup-sht30-driver-integration/sprint_1.md)
  2. [sprint_2.md (Real I2C Driver & Heater State Machine) — ✅ DONE](file:///Users/benjaminhung8405/Code/mushroom-cp/.ai/planning/setup-sht30-driver-integration/sprint_2.md)
  3. [sprint_3.md (Host Unit Test & Hardware Validation) — ✅ DONE](file:///Users/benjaminhung8405/Code/mushroom-cp/.ai/planning/setup-sht30-driver-integration/sprint_3.md)
...
### SPRINT 1: CẤU HÌNH PLATFORMIO & INCLUDE DRIVER SHT30 — ✅ DONE
...
| Status legend | — | `[ ] Pending` · `[ ] In Progress` · `[x] Done` · `[x] Done` |
