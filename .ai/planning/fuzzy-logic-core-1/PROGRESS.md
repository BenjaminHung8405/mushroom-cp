...
| F8 | Unit/integration tests cho NVS epsilon, Queue priority, encoder gestures và regression TPC. | [x] Done | - Test 30.00000→30.00001/30.09 không ghi, →30.10 ghi.<br>- Manual thắng MQTT baseline; local/MQTT clear trả về latest baseline.<br>- Verify Core 1 runtime không NVS access; SSR safety vẫn giữ khi override active. |
