...
#include "core/system_manager.h"   // hTaskCore1Control, hTaskHWButton, ScopedSerialLock
#include "network/mqtt_manager.h"   // mqtt::MqttManager::getInstance().publishStatus()
